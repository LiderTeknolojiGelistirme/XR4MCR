	...
	Properties
	{
		...
		CGPROGRAM
			...
			/* UNITY: Original start of shader */
					...
					uniform float4 _planeEquation2;
					uniform float4 _planeEquation3;
					uniform int _cuttingOn;
					uniform int _cuttingOn2;
					uniform int _cuttingOn3;
					...
					void surf(Input IN, inout SurfaceOutputStandard o)
					{
						...
						if (_cuttingOn2)
							clip(dot(IN.worldPos, _planeEquation2.xyz) - _planeEquation2.w);
						if (_cuttingOn3)
							clip(dot(IN.worldPos, _planeEquation3.xyz) - _planeEquation3.w);
