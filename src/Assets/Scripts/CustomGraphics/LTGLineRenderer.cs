...
namespace CustomGraphics
{
    ...
    public class LTGLineRenderer : MaskableGraphic
    {
        public Sprite s1;
        ...
        {
            Debug.Log("ENTER: LTGLineRenderer Construct");
        ...
        protected override void OnEnable()
        {
            ...
            {
                Debug.LogWarning("SystemManager not found at LineRenderer OnEnable().");
                return;
            }
        ...
        protected override void OnDisable()
        {
            if (_systemManager == null)
            {
                Debug.LogWarning("SystemManager not found at LineRenderer OnDisable().");
                return;
            }
